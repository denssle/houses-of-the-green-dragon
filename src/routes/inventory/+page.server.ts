...
/**
 * Das Inventar — was einem selbst gehört und nicht in einem Haus liegt (5.33).
 *
...
export const load: PageServerLoad = async ({ locals }) => {
	...
	return {
		...
		// Was das Äußere hergibt — das Inventar ist der Ort, an dem man sich damit befasst.
...
export const actions = {
	 ...
	 *
	 * **Der Ausweg gehört neben die Grenze.** Wer hier steht, weil das Inventar voll ist,
	...
	/** Und zurück: aus einem eigenen Lager ins Inventar. */
